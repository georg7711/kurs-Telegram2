...
async def process_cancel_command(message: Message):
    if users[message.from_user.id]['in_game']:
        ...
        await message.answer(
            ...
            'Может, сыграем разок? Чтобы начать /play'
        )

@dp.message(Command(commands='play'))
async def process_positive_answer1(message: Message):
    ...
    if users[message.from_user.id]['in_game']:
        if int(message.text) == users[message.from_user.id]['secret_number']:
            ...
            await message.answer(
                ...
                'Может, сыграем еще? Чтобы начать /play'
            )
        ...
        if users[message.from_user.id]['attempts'] == 0:
            ...
            await message.answer(
                ...
                'сыграем еще? Чтобы начать /play'
            )
    else:
        await message.answer('Мы еще не играем. Хотите сыграть? Чтобы начать /play')
